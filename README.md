...
ModernChat یک اپلیکیشن چت **مدرن، سریع و ریل‌تایم** است که با استفاده از **Flutter** و **Supabase** ساخته شده است.  
این پروژه با تمرکز بر طراحی حرفه‌ای، عملکرد روان و ارتباط بلادرنگ توسعه یافته است.
