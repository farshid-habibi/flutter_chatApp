...
ModernChat یک اپلیکیشن چت مدرن، سریع و ریل‌تایم ساخته شده با **Flutter** و **Supabase** است.  
این پروژه تمرکز ویژه‌ای بر طراحی مینیمال، عملکرد سریع و ارتباط بلادرنگ دارد.
